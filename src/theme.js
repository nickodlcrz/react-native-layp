...
// interestRate (% per year, accrued daily -- same mechanic as
// DEFAULT_SAVINGS_ACCOUNTS below) lets a regular budget account earn
// interest on its own, e.g. a Maribank account used for everyday spending
// that still gains interest without the money ever being moved into a
// separate savings account. Left at 0 for the seed accounts; the account's
// own edit row is where a real rate gets filled in.
export const DEFAULT_ACCOUNTS = [
  { id: "ecash", label: "E-cash", color: ACCENT.sky, interestRate: 0 },
  { id: "physical", label: "Physical", color: ACCENT.gold, interestRate: 0 },
];
...
export const INCOME_CATEGORIES = [
  ...
  // Auto-generated by accrueAccountInterest (see utils.ts) whenever an
  // interest-bearing budget account gains its daily interest -- included
  // here so it gets a real label/color anywhere moneyLog categories are
  // displayed (Activity pie chart, etc.) instead of falling back to
  // "Other".
  { id: "interest", label: "Interest", color: ACCENT.rose },
  { id: "other", label: "Other", color: ACCENT.plum },
];
